...
namespace FurnitureShop.Data.Migrations
{
    ...
    [Migration("20230115072736_Role_Permission")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FurnitureShop.Data.Entities.AppUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "0f3d5638-49bb-4b99-9a1f-e97fe637c62c",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "ADMINISTRATOR",
                            PasswordHash = "AQAAAAEAACcQAAAAECwvoBEH96QMLJIPhJLk+IyQvZ81fjceimYcBx1XRVEy2zAReHrhbYdpFKHdBsl5aA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "4950e047-6a3d-4154-83d1-cc36bbc111f4",
                            Status = 0,
            ...
            modelBuilder.Entity("FurnitureShop.Data.Entities.Favourite", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("FurnitureShop.Data.Entities.FavouriteProduct", b =>
                {
                    ...
                    b.HasIndex("FavouriteId")
                        .HasDatabaseName("ix_favourite_products_favourite_id");
            ...
            modelBuilder.Entity("FurnitureShop.Data.Entities.Message", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("FurnitureShop.Data.Entities.FavouriteProduct", b =>
                {
                    b.HasOne("FurnitureShop.Data.Entities.Favourite", "Favourite")
                        .WithMany("FavouriteProducts")
                        .HasForeignKey("FavouriteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_favourite_products_favourites_favourite_id");
