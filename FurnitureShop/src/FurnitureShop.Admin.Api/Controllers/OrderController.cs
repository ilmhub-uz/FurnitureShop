...
public class OrderController : ControllerBase
{
    ...
    public async Task<IActionResult> GetOrders(OrderFilter filter, PaginationParams pagination)
    {
        var orders = await _ordersService.GetOrdersAsync(filter, pagination);
        return Ok(orders);
    }
